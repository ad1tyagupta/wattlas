...
import type { AssetFeature, GeographyFeature, LensKey, RegionFeature, SnapshotData } from "@/lib/snapshot/types";
...
export function OpportunityRadar({ snapshot }: Props) {
  ...
  const selectableGeographies = useMemo(() => [...snapshot.countries.features, ...snapshot.regions.features] as Array<GeographyFeature | RegionFeature>, [snapshot.countries.features, snapshot.regions.features]);
